    ...
    return (
        <>
            <div className="mt-1 flex justify-center">
                <h1 className="text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-3xl dark:text-gray-900 mt-5">Les employés</h1>
            </div>
            {/* Search bar */}
                        ...
                        {currentPosts.map((post, index) => (
                            <tr key={index}>
                                <td className="px-4 py-3 font-medium">
                                    {post.roleName === "Workshop" ? "Ouvrier" : (post.roleName === "Responsible" ? "Responsable" : post.roleName)}
                                </td>
