                                ...
                                <div className="sm:flex sm:items-center">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <input
                                                onChange={(e) => setEditOperation({ ...editOperation, name: e.target.value })}
                                                value={editOperation.Machine?.name}
                                                type="text"
                                                placeholder="Machine"
                                                id="machine"
                                                className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full max-w-md mx-auto shadow-sm sm:text-sm border border-gray-400 rounded-md py-2 px-3"
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden ml-8 mr-8">
                    <table className="w-full table-auto">
                        ...
                        {currentOperations.map((operation, index) => (
                            <tr key={index}>
                                <td className="px-20 py-3 font-medium">{operation.id}</td>
                                <td className="px-14 py-3">{operation.name}</td>
                                <td className="px-14 py-3">{operation.Post?.name}</td>
                                <td className="px-14 py-3">{operation.Machine?.name}</td>
                                <td className="px-14 py-3">{operation.time}</td>
                                <td className="px-2 py-3">
                                    <button
                                        type="button"
                                        onClick={() => handleEditModalOpen(operation)}
